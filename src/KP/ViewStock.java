 ...
 * @author RiFF
 */
public class ViewStock extends javax.swing.JDialog {
     ...
     */
    public ViewStock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        LoadTable();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Available Stock"));
    ...
    private void LoadTable()
    {
       ...
       try{
            String sql="SELECT `ProductId`, `Name`, `Price`, `Quantity` as Quantity_Remaining FROM `products`";
            stm=conn.prepareStatement(sql);
            rs=stm.executeQuery(sql);
            table_stock.setModel(DbUtils.resultSetToTableModel(rs));
            resizeColumnWidth(table_stock);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewStock dialog = new ViewStock(new javax.swing.JFrame(), true);
