...
public class SalesReceipt 
{
    ...
    public void generateReceipt(String path, String ReceiptNumber)
    {
         ...
         try{
          ...
          Paragraph titl = new Paragraph("TIWI URBAN LIMITED COMPANY", FontFactory.getFont(FontFactory.HELVETICA, 14, com.itextpdf.text.Font.BOLD, BaseColor.BLACK));
          titl.setAlignment(Element.ALIGN_CENTER);
          document.add(titl);
         
          Paragraph tit2 = new Paragraph("CUSTOMER RECEIPT", FontFactory.getFont(FontFactory.HELVETICA, 12, com.itextpdf.text.Font.BOLD, BaseColor.BLACK));
          tit2.setAlignment(Element.ALIGN_CENTER);
          document.add(tit2);
          
          Paragraph tit4 = new Paragraph("RECEIPT NO: " , FontFactory.getFont(FontFactory.HELVETICA, 10, com.itextpdf.text.Font.BOLD, BaseColor.BLACK));
          tit2.setAlignment(Element.ALIGN_CENTER);
          document.add(tit4);
          ...
          Paragraph tit3 = new Paragraph("Printed on: "+ timestamp, FontFactory.getFont(FontFactory.HELVETICA, 10, com.itextpdf.text.Font.BOLD, BaseColor.BLACK));
